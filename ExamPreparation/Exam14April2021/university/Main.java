...
// Register Student
        ...
        String register1 = university.registerStudent(student);
        System.out.println(university.getCapacity()); // 3
        System.out.println(register); // Added student John Smith
        System.out.println(register1); // Student is already in the university
